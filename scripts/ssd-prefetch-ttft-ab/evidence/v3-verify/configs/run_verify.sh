#!/bin/bash
set -euo pipefail
export ROOT=/home/<user>/prefetch_916/perf_test_prefetch_v3_verify
...
echo "HEAD=$(git -C /home/<user>/prefetch_916/src/Mooncake rev-parse --short HEAD)"
echo "BRANCH=$(git -C /home/<user>/prefetch_916/src/Mooncake branch --show-current)"
