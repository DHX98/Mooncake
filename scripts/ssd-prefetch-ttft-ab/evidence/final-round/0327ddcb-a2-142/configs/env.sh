# 142 live: GLOG_v=0 pin; MODEL mtp path; KV_LEASE_TTL_MS=2000; FABRIC_IP/HCCL_IF_IP=<host-ip>; SOCKET_IFNAME=<nic>.
#!/bin/bash
...
ROOT="${ROOT:-/home/<user><user>/prefetch_916/perf_test_prefetch_v3}"
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

PKG="${PKG:-/usr/local/python3.12.13/lib/python3.12/site-packages/mooncake}"
RUNTIME="${RUNTIME:-/home/<user><user>/prefetch_916/runtime}"
