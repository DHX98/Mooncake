...
2. **回放 `serve.sh` 缺现场环境**。能跑的 v3 有 `HCCL_IF_IP=<bench-host>`、`GLOO/HCCL/TP_SOCKET_IFNAME=enp189s0f0`、`MC_METADATA_SERVER=P2PHANDSHAKE`、`LOCAL_HOSTNAME=127.0.0.1`、`--data-parallel-size 1`。HANDOFF 精简稿没有。
