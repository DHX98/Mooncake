...
class MasterService {
   ...
   public:
     ...
     *
     * Same visibility rules as GetReplicaListForAdmin. Kept as a named
     * prefetch entry so exist-probe callers do not grant leases or enqueue
     * promotion-on-hit work.
     */
